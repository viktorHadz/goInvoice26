...
const helperCopy = computed(() =>
  isSignup.value
    ? `After account creation you will be redirected to the billing screen where you can start a trial or chose a payment plan. `
...
<template>
  ...
  >
    ...
    <div class="relative isolate min-h-screen overflow-hidden">
      ...
      <section
        class="relative mx-auto flex min-h-screen w-full max-w-6xl items-center px-5 py-8 sm:px-8 sm:py-10"
      >
        <div class="grid w-full gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:gap-8">
          ...
          >
            ...
            <div class="mt-8">
              ...
              <h1
                class="mt-5 max-w-lg text-4xl font-semibold tracking-tight text-zinc-950 dark:text-white"
              >
                {{ title }}
              </h1>
          ...
          <section class="order-1 lg:order-2">
            ...
            >
              <div class="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2
                    class="mt-4 text-2xl font-semibold tracking-tight text-zinc-950 sm:text-3xl dark:text-white"
                  >
                    {{ isSignup ? 'Continue with Google' : 'Sign in with Google' }}
                  </h2>

                  <p
                    class="mt-3 max-w-xl text-sm leading-7 text-zinc-600 sm:text-base dark:text-zinc-300"
                  >
                    {{
                      isSignup
            ...
            >
              ...
              <div class="mt-4 space-y-3">
                <div
                  v-for="item in isSignup ? signupSteps : loginChecks"
