                    ...
                    <div class="relative overflow-hidden px-4 py-3">
                        ...
                        <div class="relative z-10 flex items-center justify-between gap-4">
                            <div class="flex min-w-0 items-center gap-3">
                                ...
                                >
                                    <SquaresPlusIcon
                                        class="stroke-1.5 size-7 text-sky-700 dark:text-emerald-400"
                                    />
                                </div>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <div
                                        class="text-sm tracking-tight text-zinc-500 dark:text-zinc-400"
                                    >
                        ...
                        <div class="px-2 pb-3">
                            ...
                            >
                                <div class="flex items-center justify-between gap-3">
                                    <div
                                        class="line-clamp-1 text-sm font-semibold text-zinc-900 dark:text-zinc-100"
                                    >
                                        {{ p.productName }}
                                    </div>
                                    <div
                                        class="text-xs whitespace-nowrap text-zinc-500 dark:text-zinc-400"
                                    >
                                        {{
