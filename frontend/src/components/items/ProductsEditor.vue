        ...
        <div class="px-2 pb-3">
          ...
          >
            <div class="flex items-center justify-between gap-3">
              <div class="line-clamp-1 text-sm font-semibold text-zinc-700 dark:text-zinc-100">
                {{ p.productName }}
              </div>
        ...
        <div class="mt-4 space-y-4 pb-12 sm:pb-0">
          ...
          >
            ...
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
              <div
                class="rounded-xl border border-zinc-300 bg-white px-3 py-2 dark:border-zinc-800 dark:bg-zinc-950/40"
              >
                <div
