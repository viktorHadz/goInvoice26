...
<template>
    <div class="grid grid-cols-8 grid-rows-4">
        ...
        <div class="pointer-events-none col-span-1 col-start-1 row-start-3">
            <p>Date Created:</p>
        </div>
        ...
        <div
            ...
            v-text="invoice.data.invoiceNumber"
        ></div>
        ...
        <div class="col-span-2 col-start-4 flex items-center justify-center">
            <button
                class="hover:text-acc cursor-pointer"
                title="create PDF"
            >
        ...
        <!-- Client Fields -->
        <div class="col-span-1 col-start-6 row-start-1">
