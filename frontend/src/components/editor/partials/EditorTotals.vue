...
<template>
    <div v-if="!editStore.draftInvoice || !editStore.totals" class="text-base text-zinc-600 dark:text-zinc-400">
        No invoice loaded.
    </div>

    <div v-else class="min-w-0 space-y-4 text-sm">
        <div class="grid min-w-0 grid-cols-[1fr_auto] items-center gap-3">
            ...
            <div class="shrink-0 font-semibold whitespace-nowrap text-zinc-900 tabular-nums dark:text-zinc-100">
        ...
        <div class="grid min-w-0 grid-cols-[1fr_auto] items-center gap-3">
            <div class="min-w-0 truncate text-zinc-600 dark:text-zinc-400">
                Deposit
            </div>
            <div class="shrink-0 font-semibold whitespace-nowrap text-zinc-900 tabular-nums dark:text-zinc-100">
        ...
        <div class="rounded-xl bg-zinc-50 px-3 py-3 dark:bg-zinc-900/40">
            ...
            <p class="mt-2 text-xs leading-5 text-zinc-500 dark:text-zinc-400">
                Deposits do not reduce balance due. Use payment receipts in the preview to settle this revision.
            </p>
        </div>
    </div>
</template>
