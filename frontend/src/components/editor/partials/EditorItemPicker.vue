...
<template>
    ...
    >
        <div class="border-b border-zinc-300 dark:border-zinc-800">
            <div class="hdr-grid flex items-center justify-between rounded-t-2xl font-medium">
                <div class="px-4 py-2.5">
                    ...
                    <div class="text-xs font-bold text-sky-600 dark:text-emerald-400">
                        Select existing or insert custom
                    </div>
                </div>
                ...
                >
                    <button
                        type="button"
                        class="transform-gpu rounded-full px-3 py-1.5 text-xs font-medium transition duration-300 will-change-transform outline-none focus:outline-none focus-visible:ring-1 focus-visible:ring-sky-300 focus-visible:ring-inset dark:focus-visible:ring-emerald-400/30"
                        :class="
                            itemType === 'style'
        ...
        <div class="mt-6 p-3 md:mt-0 md:p-4">
            <div class="flex flex-col gap-3 md:flex-row md:items-center">
                        ...
                        >
                            <div class="max-h-72 overflow-auto">
                                ...
                                >
                                    ...
                                    <TheButton class="shrink-0 cursor-pointer" @click.stop="addFromProduct(p)">
                ...
                <div class="flex flex-row gap-3">
                    ...
                    <div class="w-full md:w-16">
                        <div class="mb-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">Min</div>
                        <TheInput
                            v-model="form.minutes"
                            input-class="text-right py-1"
                            type="number"
                            placeholder="60"
                            :disabled="itemType !== 'sample'"
                        />
                    </div>
                </div>

                <div class="flex justify-end">
                    <TheTooltip text="Add custom item">
                        <TheButton class="w-full cursor-pointer md:w-auto" @click="addCustomItem">
                            <BriefcaseIcon class="size-4" />
                            Custom
                        </TheButton>
                    </TheTooltip>
