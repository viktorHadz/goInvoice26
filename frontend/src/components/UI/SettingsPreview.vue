...
<template>
  <div class="mt-4 rounded-2xl">
    <div
      class="mx-auto max-w-lg overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.04)] dark:border-zinc-800 dark:bg-zinc-900"
    >
      <div
      ...
      <div class="p-5">
        <div
          class="flex items-start justify-between gap-4 border-b border-zinc-200 pb-5 dark:border-zinc-800"
        >
        ...
        <div class="grid grid-cols-2 gap-3 border-b border-zinc-200 py-4 dark:border-zinc-800">
          <div class="rounded-xl bg-zinc-50 px-3 py-2 dark:bg-zinc-950/80">
            <div
        ...
        <div class="flex justify-end border-b border-zinc-200 pb-4 dark:border-zinc-800">
        ...
        <div class="grid gap-3 py-4">
          <div class="rounded-xl bg-zinc-50 p-3 dark:bg-zinc-950/80">
            <div
              class="text-tiny mb-1.5 font-semibold tracking-[0.14em] text-zinc-500 uppercase dark:text-zinc-400"
            >
              Payment terms
            </div>
            <div
