...
<template>
    <div class="mt-4 rounded-2xl">
        <div
            class="mx-auto max-w-lg overflow-hidden rounded-2xl border border-zinc-300 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.04)] dark:border-zinc-800 dark:bg-zinc-900"
        >
            <div
            ...
            <div class="p-5">
                ...
                >
                    <div class="min-w-0 flex-1">
                        ...
                        <div
                            class="mt-2 text-xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100"
                        >
                        ...
                        <div class="mt-3 space-y-1 text-xs text-zinc-600 dark:text-zinc-400">
                            ...
                            <div>
                                Issue date: {{ lineOrFallback(form.dateFormat, 'DD/MM/YYYY') }}
                            </div>
                        </div>
                    </div>
                ...
                <div
                    class="grid grid-cols-2 gap-3 border-b border-zinc-300 py-4 dark:border-zinc-800"
                >
                ...
                <div class="border-t border-zinc-300 pt-4 dark:border-zinc-800">
                    <div class="text-tiny leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{
                            lineOrFallback(
                                form.notesFooter,
                                'Footer note will appear here on each page.',
                            )
                        }}
                    </div>
                </div>
