...
const toneMap: Record<ToastNotice['level'], ToneConfig> = {
  success: {
    wrapper: 'border-green-200 bg-green-50 dark:border-emerald-400/30 dark:bg-emerald-900/90',
    ...
    >
      ...
      >
        <div
          ...
          :key="toast.id"
          class="pointer-events-auto relative rounded-md border p-4 shadow-sm transition duration-150 hover:scale-101"
