...
<template>
  ...
  >
    <div class="relative">
      ...
      >
        <ListboxOptions
          class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-zinc-300 bg-white p-1 text-sm shadow-lg focus:outline-hidden dark:border-zinc-700 dark:bg-zinc-800"
        >
          <ListboxOption
            as="template"
          ...
          >
            <li
              ...
              :class="[
                // active hover state
                active
                  ? 'bg-sky-50 text-zinc-900 dark:bg-emerald-950/50 dark:text-zinc-50'
          ...
          <div
            ...
            class="px-2 py-2 text-xs text-zinc-600 dark:text-zinc-400"
          >
            No options.
          </div>
        </ListboxOptions>
