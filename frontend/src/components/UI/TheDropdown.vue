    ...
    >
        <div class="relative">
            ...
            >
                ...
                <!-- <ChevronDownIcon
          v-else
          class="size-4 shrink-0 text-zinc-600 dark:text-zinc-400"
          aria-hidden="true"
        /> -->
            </ListboxButton>
            ...
            >
                <ListboxOptions
                    class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-zinc-300 bg-white p-1 text-sm shadow-lg focus:outline-hidden dark:border-zinc-800 dark:bg-zinc-900"
                >
                    <ListboxOption
                        as="template"
