...
const usageFeatures: UsageFeature[] = [
  {
    ...
    icon: Cog6ToothIcon,
    previewSurfaceClass: 'bg-linear-to-br from-sky-200/80 via-white to-cyan-50/80 dark:from-emerald-500/10 dark:via-zinc-950 dark:to-zinc-950',
  },
      ...
      <div class="grid gap-10 lg:grid-cols-[1.18fr_0.82fr] lg:items-center lg:gap-12">
        <div class="relative order-2 lg:order-1">
          <div
            ...
            <div class="border-b border-zinc-200/80 bg-zinc-50/70 p-4 dark:border-zinc-800 dark:bg-zinc-900/70">
              <div class="flex flex-wrap gap-2">
                <button v-for="feature in usageFeatures" :key="feature.id" type="button"
                  class="inline-flex items-center gap-2 rounded-full px-3.5 py-2 text-sm font-medium transition" :class="feature.id === activeFeature.id
            ...
            <Transition name="usage-preview" mode="out-in">
              <div :key="activeFeature.id" class="grid min-h-152 gap-4 p-4 sm:p-5 lg:p-6">
                  ...
                  <div :class="[
                    ...
                    <div class="flex items-center gap-3">
                      <div
                        ...
                        <component :is="activeFeature.icon" class="size-5" />
                      </div>
                    ...
                    <div class="mt-5 space-y-3">
                      <div v-for="row in activeFeature.rows" :key="row.title"
